                ...
                <div className='row mt-2 productDetaileModal'>
                    ...
                    <div className='col-md-7'>
                        <div className='d-flex info align-items-center mb-3'>
                            <span className='oldPrice lg mr-2'>AED: {props?.data?.oldPrice}</span>
                            <span className='netPrice text-danger lg'>AED: {props?.data?.price}</span>
                        </div>

                        <span className="badge bg-success">IN STOCK</span>

                        <p className='mt-3'>AED: {props?.data?.description}</p>
